...
def main(args):
    ...
    if args.data_name == 'imagenet':
        ...
        train_list = 'data/AID/train.txt'
        #true_hash = 'data/nus_wide/nus_wide_ha21_class.pkl'
        true_hash = 'data/AID/hash_centers/' + str(args.hash_bit) + '_AID_30_class.pkl'
        data_imbalance = 5
        two_loss_epoch = -1
        total_epoch = 90

    elif args.data_name == 'SpaceNet':
        train_list = 'data/SpaceNet/train.txt'
        #true_hash = 'data/nus_wide/nus_wide_ha21_class.pkl'
        true_hash = 'data/SpaceNet/hash_centers/' + str(args.hash_bit) + '_SpaceNet_10_class.pkl'
        data_imbalance = 10
        two_loss_epoch = -1
        total_epoch = 100
    database_list = 'data/SpaceNet/train.txt'
    test_list = 'data/SpaceNet/test.txt'
    ...
    if args.model_type == 'resnet50' or args.model_type == 'resnet152' or args.model_type == 'resnet18':
...
def train(model, args, train_loader, criterion, Hash_center, optimizer, epoch, two_loss_epoch):
    ...
    for i, (input, label) in enumerate(train_loader):
        optimizer.zero_grad()
        if args.data_name == 'imagenet' or args.data_name == 'SpaceNet':
